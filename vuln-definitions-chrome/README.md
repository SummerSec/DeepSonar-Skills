...
| `skills/vuln-definitions-chrome/references/chrome-vuln-types.md` | 浏览器攻击面形态（进程/内存/Web/Mojo/UX/扩展/GPU） |
...
- 投递习惯（非定级）：[VRP FAQ](https://chromium.googlesource.com/chromium/src/+/HEAD/docs/security/vrp-faq.md)  
