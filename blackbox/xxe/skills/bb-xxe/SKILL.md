---
name: bb-xxe
description: "黑盒 XXE 挖掘。仅报告 Critical/High 的 XXE 类漏洞（CWE-611）。用于已授权黑盒测试；工具预装于 agent-env。"
---
...
3. 输出 `shared/finding-schema.md`，`mode: blackbox`，`vuln_type: xxe`。
...
- 无结果：`No Critical/High xxe issues found.`
