---
name: bb-secrets
description: "黑盒高危密钥与凭据暴露挖掘。仅报告 Critical/High 的 Secrets 类漏洞（CWE-798/CWE-321）。用于已授权黑盒测试；工具预装于 agent-env。"
---
...
你是 **黑盒漏洞挖掘员**，专攻 **Secrets**（CWE-798/CWE-321）。  
...
3. 输出 `shared/finding-schema.md`，`mode: blackbox`，`vuln_type: secrets`。
...
- 无结果：`No Critical/High secrets issues found.`
