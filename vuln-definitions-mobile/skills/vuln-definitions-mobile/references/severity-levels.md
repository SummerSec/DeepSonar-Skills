...
- 「仅资源耗尽 / 崩溃」排除的**只有**纯崩溃与资源耗尽；**破坏性**远程 DoS（需恢复出厂等）按 **H8**
...
| H8 | 破坏性远程 DoS：远程触发且需恢复出厂设置、永久删除用户 / Profile 状态、无交互卸载 App，或反复呼出 / 阻止呼出紧急呼叫（项目口径见 `google-android-devices-rules.md` §3） |
