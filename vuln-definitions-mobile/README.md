...
| `references/mobile-vuln-types.md` | 移动端形态主表（Android AD/AW/AI/AE/AC/AB/AF/AA/AS/AT/AP/AM + iOS IU/IO/IL/ID/IW/IM/IA/IP；每行带精确条款 ID） |
...
- **移动端四档 + 形态** → 本插件（`vuln-definitions/references/mobile.md` 为**摘要**，与其不一致时以本插件为准）
